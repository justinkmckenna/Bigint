...
int main () {
    ...
    
    {
        ...
        assert(left   == "111111111111111111111111111111111111111111");
        assert(right  == 280342);
        assert(result == "31149111111111111111111111111111111111111079962");
    }

    {
        //------------------------------------------------------
        // Setup fixture
        bigint left("1701927567102987346089137450172634871");
        int right = 0;
        bigint result;
        ...
        // Verify
        assert(left   == "1701927567102987346089137450172634871");
        assert(right  == 0);
        assert(result == 0);
    }

    {
        //------------------------------------------------------
        // Setup fixture
        bigint left("1234567890098765432100");
        int right = 1234512;
        bigint result;
        ...
        // Verify
        assert(left   == "1234567890098765432100");
        assert(right  == 1234512);
        assert(result == "1524088875141607111112635200");
    }
